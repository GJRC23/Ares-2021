...
///BOTONES
    ...
    botonInicio(40,12+3*3,"[S]alir de Ares");
///AGREGADOS DE ABAJO
    gotoxy(2,27);
    printf("Derechos reservados hasta que los compre Meta.\n\n");
    gotoxy(90,27);
    printf("Ares2021©.\n\n");
//FUNCIONALIDAD
    switch(getch())
...
void Registro()
{
    ...
    gotoxy(2,7);
    printf("PASSWORD > minimo 4 caracteres \n");
    gotoxy(2,9);
    ...
    input2(2,12+6,"ANO DE NACIMIENTO");
...
void Login()
{
    ...
    else
    {
        ErrorLogin();
        /*gotoxy(20,20);
        printf("ID DE USUARIO O PASSWORD INCORRECTOS");
        boton(10, 15, "[V] VOLVER");
        boton(10, 10, "[I] INTENTAR DE NUEVO");
        switch(getch())
        {
        case 'i':
            system("cls");
